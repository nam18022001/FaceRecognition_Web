...
<div class="col-lg-8 themnhanvien">
    ...
    @endif  
    <div class="mt-5">
        <h2 class=" col-md-12 text-center font-bold"><strong>Thêm Giáo Viên</strong></h2>

    <!-- First Step -->
    <form class="form-horizontal mt-3" action="{{url('admin/giaovien/them')}}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class=" setup-content-2 mt-5" id="step-1">
            <div class="col-md-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label for="MSSV" class="col-md-3 control-label">Mã Giáo Viên</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        <label for="tang" class="col-md-3 control-label">Chọn Môn Dạy</label>
                        <div class="col-md-9">
                            <select class="form-control select" name="monhoc" id="tang">
